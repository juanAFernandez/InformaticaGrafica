    ...
    private:
        ...
        //Detalles
            ...
            glPushMatrix();
                ...
                glScaled(20,1,1);
                dibujarCubo(GRIS_OSCURO, plasticoGrisOscuro);
            glPopMatrix();
            ...
            glPushMatrix();
                ...
                glScaled(1,10,1);
                dibujarCilindro(GRIS_OSCURO, plasticoGrisOscuro);
            glPopMatrix();
            ...
            //Focos delanteros:
             ...
             glPushMatrix();
                glTranslated(5,7.5,34);
                glScaled(2,2,1);
                glRotated(90,1,0,0);
                dibujarCilindro(AMARILLO, plasticoAmarillo);
            glPopMatrix();
        ...
        void dibujarCuerpo(){
            ...
            glPushMatrix();
               ...
               dibujarRuedas();
                //Dibujar chasis gris
               dibujarChasis(GRIS_CLARO, plasticoGrisClaro);
            glPopMatrix();
        ...
        void dibujarRueda(){
            ...
            for(int i=0; i<numRadios; i++){
                glPushMatrix();
                    ...
                    glScaled(1,8,1);
                    glEnable(GL_NORMALIZE);
                        dibujarCubo(GRIS_CLARO, plasticoGrisClaro);
