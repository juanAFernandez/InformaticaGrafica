...
const GLfloat NARANJA[]={1.0,0.5,0.0};
const GLfloat VIOLETA[]={1.0,0.0,1.0};
const GLfloat MARRON_OSCURO[]={0.72,0.52,0.043};
const GLfloat MARRON_CLARO[]={0.54,0.27,0.07};


const GLfloat GRIS_OSCURO[]={0.5,0.5,0.5};
const GLfloat GRIS_CLARO[]={0.8,0.8,0.8};

const GLfloat BLANCO[]={1,1,1};

//Muchos más colores en: http://www.avatar.se/molscript/doc/colour_names.html
