...
/*Incluimos la nueva estructura que hemos creado para que pueda ser usada aquí #include <figura.h> pero como
el include de ese fichero se ha realizado en user_code.h donde también se requería ya no es necesario incluirla aquí.
*/
#include "user_code.h"
...
//Ahora seleccionamos el modo, VERTICES, ALAMBRE O SÓLIDO
